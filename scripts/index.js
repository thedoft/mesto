...
function saveProfile (evt) {
  ...
  profileName.textContent = editPopup.querySelector('.popup__input_type_name').value;
  profileJob.textContent = editPopup.querySelector('.popup__input_type_job').value;
...
function addCard (evt) {
  ...
  const item = {
    name: addPopup.querySelector('.popup__input_type_place').value,
